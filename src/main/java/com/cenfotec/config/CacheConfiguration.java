...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.cenfotec.domain.Ejemplo.class.getName());
            createCache(cm, com.cenfotec.domain.Category.class.getName());
            createCache(cm, com.cenfotec.domain.Category.class.getName() + ".products");
            createCache(cm, com.cenfotec.domain.Product.class.getName());
            createCache(cm, com.cenfotec.domain.Product.class.getName() + ".categories");
            createCache(cm, com.cenfotec.domain.Customer.class.getName());
            createCache(cm, com.cenfotec.domain.Customer.class.getName() + ".addresses");
            createCache(cm, com.cenfotec.domain.Address.class.getName());
