...
import com.cenfotec.domain.Category;
import com.cenfotec.domain.enumeration.CategoryStatus;
import com.cenfotec.domain.enumeration.Genero;
import com.cenfotec.repository.CategoryRepository;
import com.cenfotec.service.CategoryService;
...
class CategoryResourceIT {
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getGenero()).isEqualTo(DEFAULT_GENERO);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        assertThat(testCategory.getGenero()).isEqualTo(UPDATED_GENERO);
    }
